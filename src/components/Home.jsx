...
const Home = () => {
  ...
  <div class="container mx-auto px-4">
    <div class="max-w-3xl mx-auto text-center">
      <h1 class="text-4xl md:text-5xl text-white font-bold text-blackish">Welcome to Mentor.Connect</h1>
      <p class="text-xl md:text-2xl text-white mt-4 text-[#4d79ff]">Unlock your potential with our free top-notch educational programs</p>
